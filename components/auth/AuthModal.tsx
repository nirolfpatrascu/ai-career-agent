...
export default function AuthModal({ isOpen, onClose, defaultMode = 'signin' }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md mx-4 bg-surface border border-white/[0.10] rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="px-8 py-8">
          {emailSent ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-2">{t('auth.checkEmail')}</h3>
              <p className="text-sm text-text-secondary">{t('auth.confirmationSent')}</p>
            ...
            <>
              ...
              <div className="space-y-2.5 mb-5">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-white/[0.06] hover:bg-white/[0.10] border border-white/[0.10] rounded-xl px-4 py-3 text-sm font-medium text-text-primary transition-colors"
                >
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-xs text-text-tertiary">{t('auth.orEmail')}</span>
                <div className="flex-1 h-px bg-white/[0.10]" />
              </div>
              ...
              <div className="space-y-3">
                ...
                {error && (
                  <p className="text-sm text-danger bg-danger/[0.06] border border-danger/15 rounded-lg px-3 py-2">
                    {error}
                  </p>
                )}
