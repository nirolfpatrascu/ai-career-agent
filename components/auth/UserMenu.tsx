    ...
    <>
      ...
      <div className="space-y-2 mb-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 bg-white/[0.06] hover:bg-white/[0.10] border border-white/[0.10] rounded-lg px-3 py-2.5 text-xs font-medium text-text-primary transition-colors"
        >
      ...
      <div className="space-y-2">
        {mode === 'signup' && (
          <input type="text" placeholder={t('auth.fullName')} value={fullName}
            ...
            className="w-full bg-white/[0.06] border border-white/[0.10] rounded-lg px-3 py-2 text-sm text-text-primary placeholder-text-tertiary focus:outline-none focus:ring-1 focus:ring-primary/30"
            autoComplete="name" />
        )}
  ...
  if (!user) {
    return (
      <div ref={menuRef} className="relative">
        ...
        {menuOpen && (
          <div className="absolute right-0 top-full mt-2 w-72 bg-surface/95 backdrop-blur-xl border border-white/[0.12] rounded-xl shadow-xl shadow-black/50 p-4 z-50">
