...
export default function PDFReport({ result }: PDFReportProps) {
  ...
  const labels: PDFLabels = {
    ...
    // New sections
    jobMatch: t('pdf.jobMatch'),
    matchScore: t('pdf.matchScore'),
    matchingSkills: t('pdf.matchingSkills'),
    missingSkills: t('pdf.missingSkills'),
    overallAdvice: t('pdf.overallAdvice'),
    cvSuggestions: t('pdf.cvSuggestions'),
    suggested: t('pdf.suggested'),
    reasoning: t('pdf.reasoning'),
    atsScore: t('pdf.atsScore'),
    keywordScore: t('pdf.keywordScore'),
    formatScore: t('pdf.formatScore'),
    formatIssues: t('pdf.formatIssues'),
    recommendations: t('pdf.recommendations'),
    githubAnalysis: t('pdf.githubAnalysis'),
    projectIdea: t('pdf.projectIdea'),
    improvements: t('pdf.improvements'),
    whyRelevant: t('pdf.whyRelevant'),
    estimatedTime: t('pdf.estimatedTime'),
    coverLetter: t('pdf.coverLetter'),
    tone: t('pdf.tone'),
    weaknessAcknowledgments: t('pdf.weaknessAcknowledgments'),
    strengthHighlights: t('pdf.strengthHighlights'),
  };
