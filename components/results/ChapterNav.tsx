...
const TABS: Tab[] = [
  ...
  { id: 'strengths', labelKey: 'results.strengths.title', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
  { id: 'gaps', labelKey: 'results.gaps.title', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg> },
...
const CV_OPTIMIZER_TAB: Tab = {
  id: 'cv-optimizer',
  labelKey: 'nav.cvOptimizer',
  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/></svg>,
};
...
export default function ChapterNav({ hasJobMatch, hasAtsScore, activeTab, onTabChange }: ChapterNavProps) {
  ...
  const tabs: Tab[] = useMemo(() => [
    ...
    ...((hasAtsScore || hasJobMatch) ? [CV_OPTIMIZER_TAB] : []),
    COACH_TAB,
